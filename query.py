...
def query_rag(query_text: str,selected_files, num_questions,ai_selector,EmbModel):
    ...
    prompt = prompt_template.format(context = context_text,question=query_text , num_questions=num_questions)
    ...
    if ai_selector == "LLAMA3.2":
        ...
        response_text = response.choices[0].message.content.replace("Answer","\nAnswer")
